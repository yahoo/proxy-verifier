...
client = r.AddClientProcess("client1", "replay_files/fields_match.json", other_args="--strict")
server = r.AddServerProcess("server1", "replay_files/fields_match.json", other_args="--strict")
...
client = r.AddClientProcess("client2", "replay_files/fields_differ.json", other_args="--strict")
server = r.AddServerProcess("server2", "replay_files/fields_differ.json", other_args="--strict")
