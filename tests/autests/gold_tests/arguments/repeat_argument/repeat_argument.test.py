...
client.Streams.stdout += Testers.ContainsExpression('Parsed 8 transactions',
                                                    'Verify the 8 transactions were parsed.')
client.Streams.stdout += Testers.ContainsExpression('8 transactions in 5 sessions',
...
client = r.AddClientProcess("client2", "replay_files/two_files", other_args="--repeat 1")
...
client = r.AddClientProcess("client3", "replay_files/two_files", other_args="--repeat 0")
...
client.Streams.stdout += Testers.ContainsExpression('Parsed 8 transactions',
                                                    'Verify the 8 transactions were parsed.')
client.Streams.stdout += Testers.ContainsExpression('0 transactions in 0 sessions',
...
client = r.AddClientProcess("client4", "replay_files/two_files", other_args="--repeat 2")
...
client.Streams.stdout += Testers.ContainsExpression('Parsed 8 transactions',
                                                    'Verify the 8 transactions were parsed.')
client.Streams.stdout += Testers.ContainsExpression('16 transactions in 10 sessions',
...
client = r.AddClientProcess("client5", "replay_files/two_files", other_args="--repeat 10")
...
client.Streams.stdout += Testers.ContainsExpression(
    '80 transactions in 50 sessions', 'Verify each transaction is executed ten times.')
