...
proxy = tr.AddProxyProcess("proxy", listen_port=client.Variables.https_port,
                           server_port=server.Variables.https_port, use_ssl=True,
                           close_on_goaway=True, use_http2_to_2=True)
...
tr.Streams.stdout += Testers.ContainsExpression(
    "Failed to submit DATA frame for key 4 on stream 3: -510", "uuid: 4 should fail")
